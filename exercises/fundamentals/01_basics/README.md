...
```bash
go test ./exercises/fundamentals/01_basics/... -v
```
...
```bash
go test ./exercises/fundamentals/01_basics/... -v -run TestCelsiusToFahrenheit
go test ./exercises/fundamentals/01_basics/... -v -run TestSwapInts
go test ./exercises/fundamentals/01_basics/... -v -run TestCharacterCount
go test ./exercises/fundamentals/01_basics/... -v -run TestMinMax
go test ./exercises/fundamentals/01_basics/... -v -run TestDirectionName
```
...
ok      go-learning-guide/exercises/fundamentals/01_basics
```
