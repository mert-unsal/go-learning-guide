...
if !reflect.DeepEqual(DeepCopySlice([]int{4, 5}), []int{4, 5}) {
...
r, err := SafeDivideEx(10, 2)
if err != nil || r != 5 {
t.Errorf("SafeDivide(10,2) = (%d,%v), want (5,nil)", r, err)
}
r, err = SafeDivideEx(10, 0)
if err == nil {
...
got := UniqueInts([]int{3, 1, 4, 1, 5, 9, 2, 6, 5, 3})
