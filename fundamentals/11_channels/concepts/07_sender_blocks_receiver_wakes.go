...
// DemonstrateSenderBlocksReceiverWakes shows the full sudog lifecycle:
// a sender blocks on a full buffered channel, then a receiver frees
// space and wakes the sender.
func DemonstrateSenderBlocksReceiverWakes() {
