...
// DemonstrateCloseWakesReceivers shows that closing a channel wakes
// all goroutines blocked on receive. Each gets (zero-value, false).
func DemonstrateCloseWakesReceivers() {
