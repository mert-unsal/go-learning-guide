...
// DemonstrateSelectMultiChannel shows select watching three channels,
// with only one receiving a value. The output proves which channel
// won and that the goroutine was waiting on all three.
func DemonstrateSelectMultiChannel() {
