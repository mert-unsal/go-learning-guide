...
// DemonstrateSemaphoreBoundedConcurrency shows a buffered channel
// limiting concurrent goroutines. An atomic counter proves that at
// most maxConcurrent tasks run at any given time.
func DemonstrateSemaphoreBoundedConcurrency() {
	const numTasks = 10
