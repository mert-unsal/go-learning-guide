...
// DemonstrateWorkerPoolBackpressure shows N workers consuming from a
// shared jobs channel with natural backpressure from a small buffer.
func DemonstrateWorkerPoolBackpressure() {
	const numWorkers = 3
	const numJobs = 10
