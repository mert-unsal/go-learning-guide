...
// DemonstrateTimeoutWithContext shows the correct timeout pattern using
// context.WithTimeout: fast operations complete, slow operations are
// cancelled, and cancel() cleans up resources immediately.
func DemonstrateTimeoutWithContext() {
