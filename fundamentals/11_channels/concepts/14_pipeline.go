...
// DemonstratePipeline shows a three-stage pipeline:
// generate(1..5) → double → addTen → collect results.
// Each value flows through every stage, transformed at each step.
