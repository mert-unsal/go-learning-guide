...
// DemonstrateUnbufferedDirectTransfer shows that an unbuffered channel
// blocks the sender until the receiver is ready, proving the direct
// goroutine-to-goroutine handoff with timing evidence.
func DemonstrateUnbufferedDirectTransfer() {
