...
// DemonstrateBufferedChannelLifecycle walks through the full lifecycle
// of a buffered channel: create, fill, partial drain, and re-fill to
// show sendx wrapping around the ring buffer.
func DemonstrateBufferedChannelLifecycle() {
